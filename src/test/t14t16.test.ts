...
describe('T14 — 상성 판정: finishingElement 기준 (다수결 제거 확인)', () => {
...
describe('T16-P1 — 시뮬 층 전환 talismans 유지', () => {
...
describe('T16-P2 — fullCapCalcExpectedDamage amplifyActive 반영', () => {
...
describe('T16-P3 — fullCapSelectCards talismans 파라미터 추가', () => {
