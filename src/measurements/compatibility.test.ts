...
describe.skip('T14 — 융합 finishingElement = fusion.result', () => {
...
describe.skip('T14 — 기운 모으기 finishingElement = 모으는 기운', () => {
...
describe.skip('T14 — 옹기가마(화+토) 타격 속성=土, 상성 매트릭스', () => {
  /**
...
describe.skip('T14 — 엔진 융합 타격 속성 기준 상성 배율', () => {
  /**
...
describe.skip('Phase 1.9.5 재작업 — 상관(傷官) 패시브 ×1.25 엔진 연동 (R8: 배율 1.3→1.25)', () => {
  it('화 3장 + 상관 패시브 → 데미지 ×1.25 적용', () => {
  ...
  it('화 2장 + 상관 패시브 → ×1.25 미적용 (R8: 3장 미만)', () => {
    const h1 = makeCard('hwa', 8, 'compat-hwa-a')
    const h2 = makeCard('hwa', 8, 'compat-hwa-b')
...
describe.skip('Phase 1.9.5 재작업 — upgrade-card 보상 등장 보장', () => {
...
describe.skip('Phase 1.9.5 재작업 — getCondenseMultiplier 배율 반환', () => {
...
describe.skip('Phase 1.9.5 재작업 — advanceToNextFloor 영속 덱', () => {
...
describe.skip('T14 — judgeHand finishingElement 전달 (하위 호환)', () => {
