...
// A-1. [기운 충돌] 테스트
// ----------------------------------------------------------------
describe.skip('A-1. 기운 충돌 (detectElementClash)', () => {
...
// A-2. [주 기운 원칙] 테스트
// ----------------------------------------------------------------
describe.skip('A-2. 주 기운 원칙 (determinePrimaryElement / calcGeukBonusMultiplier)', () => {
...
// A-3. [적의 반극] 테스트
// ----------------------------------------------------------------
describe.skip('A-3. 적의 반극 (detectYeokgeukPenalty)', () => {
...
// ----------------------------------------------------------------
describe.skip('C. 패시브 정비 — 십성 7종 검증', () => {
