...
describe.skip('Phase 1.9 조합 판정: 오행연환', () => {
...
describe.skip('Phase 1.9 조합 판정: 기운 모으기', () => {
...
describe.skip('Phase 1.9 조합 판정: 융합', () => {
...
describe.skip('Phase 1.9 조합 판정: 우선순위', () => {
...
describe.skip('Phase 1.9 조합 판정: 기본 구조', () => {
  it('카드 없음 → none', () => {
