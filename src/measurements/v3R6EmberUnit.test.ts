...
describe.skip('R6 잔불 버그 수정 — effectMode=true + wildfire(들불)', () => {
...
describe.skip('R6 잔불 3틱 합산 = rawBase × EMBER_MULTIPLIER × EMBER_DURATION (수식 검증)', () => {
...
describe.skip('R6 잔불 버그 수정 — effectMode=false (공격 모드) 기존 동작 유지', () => {
...
describe.skip('R6 잔불 EMBER_DURATION 소멸 검증', () => {
