...
describe.skip('편재(偏財) v2: 턴 종료 20% 고값 카드 추가', () => {
...
describe.skip('겁재(劫財) v2: 전투 시작 훅', () => {
...
describe.skip('상관(傷官) v2: 황금비 정점 발동 RNG', () => {
...
describe.skip('식신(食神) v2: 밥알 누적 + 융합 소비', () => {
  it('밥알 <5: 융합 시 배율 없음', () => {
...
describe.skip('비견(比肩) v2: 첫 융합 복제', () => {
...
describe.skip('편관(偏官) v2: 피해 ≥15% enemyMaxHp → 추가 출수권', () => {
...
describe.skip('정관(正官) v2: effectMode 시 synergyMultiplier ×1.5', () => {
...
describe.skip('편인(偏印) v2: 소융합(2장) 피해 ×1.6', () => {
...
describe.skip('정재(正財) v2: 오행연환 발동 시 2장 드로우', () => {
...
describe.skip('정인(正印) v2: 사망 가로채기 런당 1회', () => {
